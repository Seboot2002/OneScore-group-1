      ...
      body: Obx(() {
        ...
        return NotificationListener<OverscrollIndicatorNotification>(
          onNotification: (notification) {
            notification.disallowIndicator(); // Elimina efectos de over-scroll
            return true;
          },
          child: SingleChildScrollView(
            physics:
                const ClampingScrollPhysics(), // Sin rebote iOS, comportamiento Android
            child: Container(
                      ...
                      Container(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            ...
                            Get.offNamed(target, arguments: authControl.user);
                          },
                          child: const Text(
                            'Ver todos',
                            style: TextStyle(
